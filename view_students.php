...
?>
    <h2>All Students</h2>
    <a href="add_student.php" class="add-link">+ Add New Student</a>
            ...
            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="delete_student.php?id=<?php echo $row['student_id']; ?>" onclick="return confirm('Delete this student?');">Delete</a>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
