...
?>
    ...
    <a href="add_status_history.php" class="add-link">+ Add New Record</a>
        ...
        <tbody>
            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                <tr>
                    ...
                    <td>
                        <a href="edit_status_history.php?id=<?php echo $row['id']; ?>">Edit</a> |
                        <a href="delete_status_history.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Delete this record?');">Delete</a>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
