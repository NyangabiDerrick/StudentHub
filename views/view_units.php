...
?>
    <h2>All Units</h2>
    <a href="../add/add_unit.php" class="add-link">+ Add New Unit</a>
        ...
        <tbody>
            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                <tr>
                    ...
                    <td>
                        <a href="../edit/edit_unit.php?id=<?php echo $row['unit_id']; ?>">Edit</a> |
                        <a href="../delete/delete_unit.php?id=<?php echo $row['unit_id']; ?>" onclick="return confirm('Delete this unit?');">Delete</a>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
