        ...
        <tbody>
            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                <tr>
                    ...
                    <td>
                        <a href="edit_certificate.php?id=<?php echo $row['id']; ?>">Edit</a> |
                        <a href="delete_certificate.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Delete this certificate?');">Delete</a>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
