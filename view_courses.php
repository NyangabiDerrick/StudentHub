...
?>
    <h2>All Courses</h2>
    <a href="add_course.php" class="add-link">+ Add New Course</a>
            ...
            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="delete_course.php?id=<?php echo $row['course_id']; ?>" onclick="return confirm('Delete this course?');">Delete</a>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
